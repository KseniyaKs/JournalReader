...
import com.example.articlestest.huinya.base.presentation.view.ArticleToolbar
...
fun ArticleDetailsContent(state: ArticleDetailsViewState, viewModel: ArticleDetailsViewModel) {
    ...
    Column(
        ...
        Column(
            ...
            LikeAndComment(
                amountOfLike = article.likeCount.toString(),
                amountOfComment = article.comments.size.toString()
            )
        }
    }
}